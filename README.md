...
The data is available as GitHub Releases, compressed in 2 separate zip files, one containing data about household (hogar) and another one containing data about individuals (individual). More information about the data can be found [here](https://www.indec.gob.ar/ftp/cuadros/menusuperior/eph/EPH_registro_2T2024.pdf) (in spanish).
